...
import 'package:testproject/utilities/dialogs/cannot_share_empty_note_dialog.dart';
// import 'package:testproject/services/crud/notes_service.dart';
import 'package:testproject/utilities/generics/get_arguments.dart';
          ...
          IconButton(
              onPressed: () async {
                ...
                if (_note != null || text.isEmpty) {
                  await showCannotShareEmptySnoteDialog(context);
                } else {
                  Share.share(text);
                }
              },
          ...
          switch (snapshot.connectionState) {
            case ConnectionState.done:
              ...
              return TextField(
                ...
                maxLines:
                    null, //Textfield becomes responsive and grows as more text is typed inside
